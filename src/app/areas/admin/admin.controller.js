class AdminCtrl {
    ...
    getLocationAndLabelList() {
        ...
        this._LabelService._locations.$loaded().then(locations => {
    ...
    addLabel(label) {
        this._LabelService
            .addLabel(label.name, label.description)
            .then(() => (this.labelForm = {}));
    }

    addLocation(location) {
        this._LabelService
            .addLocation(location.name, location.description, location.labels)
            .then(() => {
                this.getLocationAndLabelList();
                this.locationForm = {};
            });
